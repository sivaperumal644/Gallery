...
public class ImageActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<ImageListActivity>>, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView techListView = (ListView) findViewById(R.id.listview);
        ...
        ImageActivity.ImageAsyncTask task = new ImageActivity.ImageAsyncTask();
...
// Create and start a new Thread
    ...
    private class ImageAsyncTask extends AsyncTask<String, Void, List<ImageListActivity>> {
        @Override
