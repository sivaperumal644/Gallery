...
public class FlickrQueryUtils {
    public static final String LOG_TAG = ImageActivity.class.getName();
    ...
    private FlickrQueryUtils() {
    }
    /**
     * Return a list of {@link ImageListActivity} objects that has been built up from
    ...
    private static List<ImageListActivity> extractFeatureFromJson(String flickrJSON) {
        ...
        try {
            ...
            //JSONArray FlickrImage = baseJsonResponse.getJSONArray("photo");
            ...
            for (int i = 0; i < photo.length(); i++) {
                ...
                if (currentImage.has("url_s")) {
                    url = currentImage.getString("url_s");
                }
                else{
                    url = "not aplicable";
                }
        ...
        Log.d("images size", "The size: " + images.size());

        return images;
    }
    /**
     * Query the USGS dataset and return a list of {@link ImageListActivity} objects.
     */

    public static List<ImageListActivity> fetchTechData(String requestUrl) {
        ...
        List<ImageListActivity> image = extractFeatureFromJson(jsonResponse);
